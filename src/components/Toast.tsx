...
export const Toast: React.FC<ToastProps> = ({ message, icon = 'check_circle', onClose }) => {
  ...
  return (
    <div className="fixed top-16 left-1/2 -translate-x-1/2 z-[100] max-w-[90vw] sm:max-w-md w-auto animate-in slide-in-from-top-4 fade-in duration-200 pointer-events-none">
